...
<el-table :data="tableData">
  ...
  <el-table-column prop="area" label="地点" width="150"></el-table-column>
  ...
  <el-table-column prop="introduction" label="简介" width="200"></el-table-column>
  ...
  <el-dialog  title="用户信息" :visible.sync="dialogFormVisible" width="30%" >
    <el-form label-width="80px" size="small">
      ...
      <el-form-item label="图片">
        <el-image :src="form.image" style="width: 120px;height: 120px"></el-image>
      </el-form-item>
...
export default {
  ...
  methods:{
     load(){
       this.request.get( this.$baseUrl+"/admin/area/page",{
         params:{
    ...
    save(){
      this.request.post(this.$baseUrl+"/admin/area/save",this.form).then(res=>{
        if(res){
    ...
    dele(id){
      this.request.delete(this.$baseUrl+"/admin/area/"+id).then(res=>{
        if(res){
